...
public class VasusToolsQAExcel {//creating object of ExcelUtils class
    ...
    public static  void main(String args[]) throws IOException {
        ...
        excelUtils.setExcelFile("C:\\Users\\CT181LL\\eclipse-workspace\\MavenTestNGProject\\PersonalDataSource.xls","Sheet1");
        ...
        for(int i=1;i<=excelUtils.getRowCountInSheet();i++)
        {
            ...
            if (confirmationMessage.isDisplayed()) {
                ...
                excelUtils.setCellValue(i,6,"PASS","C:\\Users\\CT181LL\\eclipse-workspace\\MavenTestNGProject\\PersonalDataSource.xls");
            } else {
                //if the message is not displayed , write FAIL in the excel sheet using the method of ExcelUtils
                excelUtils.setCellValue(i,6,"FAIL","C:\\Users\\CT181LL\\eclipse-workspace\\MavenTestNGProject\\PersonalDataSource.xls");
            }
